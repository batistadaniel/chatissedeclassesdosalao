    ...
    void listarServicos() {
        ...
        if (servicos.isEmpty()) {
            ...
            for (int i = 0; i < servicos.size(); i++) {
                System.out.println((i + 1) + " - " + servicos.get(i).getNome() + " (Código: " + servicos.get(i).getCodigo() + ")" + " Descricao: " + servicos.get(i).getDescricao());
            }
        }
    }
...
//                    funcionario.menuFuncionario(this);
    ...
    void cadastrarAgendamento() {
        ...
        Agendamento agendamento = new Agendamento(nome, descricao, codigo, valorServico, funcionario, cliente, data, hora);
    ...
    void listarAgendamentos() {
        ...
        if (agendamentos.isEmpty()) {
            ...
            for (Agendamento agendamento : agendamentos) {
                System.out.println("Serviço: " + agendamento.getNome());
...
class Servico {
    ...
    public Servico(String nome, String descricao, String codigo, double valorServico) {
        this.nome = nome;
...
class Agendamento extends Servico {
    ...
    Agendamento(String nome, String descricao, String codigo, double valorServico, Funcionario funcionario, Cliente cliente, LocalDate dataAgendamento, LocalTime horaAgendamento) {
        super(nome, descricao, codigo, valorServico);
